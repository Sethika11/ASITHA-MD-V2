...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=2uIFADzZ#67zIEQmGPHakq1PT6-jLrdRVLdKQRZxqDREX21LKK_0' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "> *💞Hello , I am alive now!! ||| BOT GRUOP LINK 👇 https://chat.whatsapp.com/EA8scSIjQn1LRkmEJKkPwQ JOIN NOW 🔥❤️*" : process.env.ALIVE_MSG,
...
NEWS_JID: process.env.NEWS_JID === undefined ? "120363364931963700@g.us" : process.env.NEWS_JID,
